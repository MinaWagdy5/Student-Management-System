...
class Ui_MainWindow(object):
    ...
    def search_class(self):
        ...
        class_name = self.Class_SearchBar.text()
        student_df = pd.read_csv("student_courses.csv")
        professor_df = pd.read_csv("professor_courses.csv")
        class_df = pd.read_csv("class.csv")
        # student_df = student_df.drop(student_df.columns[student_df.eq('[]').all()],axis=1)
        # professor_df = professor_df.drop(professor_df.columns[professor_df.eq('[]').all()],axis=1)

        df = pd.concat([student_df, professor_df], ignore_index=True)
        # print(df)
        grouped = df[df['course_name'] == class_name]
        print(grouped)
        print(class_df)
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/closeAsset 43.png"),
        ...
        sizePolicy.setHeightForWidth(
            self.mainBodyTabs.sizePolicy().hasHeightForWidth())
        ...
        self.Prof_Age_SpinBox.setStyleSheet("QSpinBox {\n"
                                            ...
                                            "}\n"
                                            "")
        self.Prof_Age_SpinBox.setButtonSymbols(
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/plus.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/search.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Student_Search_Btn_3 = QtWidgets.QPushButton(
            self.Add_Prof_Class_Tab)
        self.Student_Search_Btn_3.setStyleSheet("QPushButton {\n"
                                                "    border: 2px solid rgb(51,51,51);\n"
                                                "    border-radius: 5px;    \n"
                                                "    color:rgb(255,255,255);\n"
                                                "    background-color: rgb(51,51,51);\n"
                                                ...
                                                "    background-color: rgb(112,112,112);\n"
                                                "}")
        self.Student_Search_Btn_3.setText("")
        self.Student_Search_Btn_3.setIcon(icon2)
        self.Student_Search_Btn_3.setObjectName("Student_Search_Btn_3")
        self.gridLayout.addWidget(self.Student_Search_Btn_3, 0, 1, 1, 1)
        self.Prof_Search_Result2 = QtWidgets.QListWidget(
            self.Add_Prof_Class_Tab)
        self.Prof_Search_Result2.setStyleSheet("QListWidget {\n"
        ...
        self.Student_Search_Btn_4 = QtWidgets.QPushButton(
            self.Add_Prof_Class_Tab)
        self.Student_Search_Btn_4.setStyleSheet("QPushButton {\n"
                                                "    border: 2px solid rgb(51,51,51);\n"
                                                "    border-radius: 5px;    \n"
                                                "    color:rgb(255,255,255);\n"
                                                "    background-color: rgb(51,51,51);\n"
                                                ...
                                                "    background-color: rgb(112,112,112);\n"
                                                "}")
        self.Student_Search_Btn_4.setText("")
        self.Student_Search_Btn_4.setIcon(icon2)
        self.Student_Search_Btn_4.setObjectName("Student_Search_Btn_4")
        self.gridLayout.addWidget(self.Student_Search_Btn_4, 2, 1, 1, 1)
        self.Class_Search_Result2 = QtWidgets.QListWidget(
            self.Add_Prof_Class_Tab)
        self.Class_Search_Result2.setStyleSheet("QListWidget {\n"
                                                "  border: 2px solid rgb(56, 56, 56);\n"
                                                "\n"
                                                "}\n"
                                                "\n"
        ...
        self.Add_Prof_Class_Btn = QtWidgets.QPushButton(
            self.Add_Prof_Class_Tab)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/add.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Student_Search_Bar2 = QtWidgets.QLineEdit(
            self.Add_Student_Class_Tab)
        ...
        self.Student_Search_Btn_5 = QtWidgets.QPushButton(
            self.Add_Student_Class_Tab)
        self.Student_Search_Btn_5.setStyleSheet("QPushButton {\n"
                                                "    border: 2px solid rgb(51,51,51);\n"
                                                "    border-radius: 5px;    \n"
                                                "    color:rgb(255,255,255);\n"
                                                "    background-color: rgb(51,51,51);\n"
                                                ...
                                                "    background-color: rgb(112,112,112);\n"
                                                "}")
        self.Student_Search_Btn_5.setText("")
        self.Student_Search_Btn_5.setIcon(icon2)
        self.Student_Search_Btn_5.setObjectName("Student_Search_Btn_5")
        self.gridLayout_2.addWidget(self.Student_Search_Btn_5, 0, 1, 1, 1)
        self.Student_Search_Result2 = QtWidgets.QListWidget(
            self.Add_Student_Class_Tab)
        self.Student_Search_Result2.setStyleSheet("QListWidget {\n"
                                                  "  border: 2px solid rgb(56, 56, 56);\n"
                                                  "  \n"
                                                  "}\n"
                                                  "\n"
        ...
        self.Class_Search_Bar3 = QtWidgets.QLineEdit(
            self.Add_Student_Class_Tab)
        ...
        self.Student_Search_Btn_6 = QtWidgets.QPushButton(
            self.Add_Student_Class_Tab)
        self.Student_Search_Btn_6.setStyleSheet("QPushButton {\n"
                                                "    border: 2px solid rgb(51,51,51);\n"
                                                "    border-radius: 5px;    \n"
                                                "    color:rgb(255,255,255);\n"
                                                "    background-color: rgb(51,51,51);\n"
                                                ...
                                                "    background-color: rgb(112,112,112);\n"
                                                "}")
        self.Student_Search_Btn_6.setText("")
        self.Student_Search_Btn_6.setIcon(icon2)
        self.Student_Search_Btn_6.setObjectName("Student_Search_Btn_6")
        self.gridLayout_2.addWidget(self.Student_Search_Btn_6, 2, 1, 1, 1)
        self.Class_Search_Result3 = QtWidgets.QListWidget(
            self.Add_Student_Class_Tab)
        self.Class_Search_Result3.setStyleSheet("QListWidget {\n"
                                                "  border: 2px solid rgb(56, 56, 56);\n"
                                                "  \n"
                                                "}\n"
                                                "\n"
        ...
        self.Add_Student_Class_Btn = QtWidgets.QPushButton(
            self.Add_Student_Class_Tab)
        ...
        self.Class_Search_Bar3_Btn.addTab(
            self.Add_Student_Class_Tab, icon3, "")
        ...
        self.Class_Search_Result.setStyleSheet("QListWidget {\n"
                                               "  border: 2px solid rgb(56, 56, 56);\n"
                                               "  \n"
                                               "}\n"
                                               "\n"
        ...
        self.horizontalLayout_25.addWidget(
            self.Student_Age_SpinBox, 0, QtCore.Qt.AlignHCenter)
        ...
        sizePolicy.setHeightForWidth(
            self.Dashboard_Btn.sizePolicy().hasHeightForWidth())
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/home.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.studentsFrame_6.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Students_Btn.sizePolicy().hasHeightForWidth())
        ...
        self.Students_Btn.setStyleSheet("/* STYLESHEET FOR PUSH BUTTON: START, SAVE, CLOSE, RESTORE, CONNECT, EDIT */\n"
                                        ...
                                        " /* SEE THE EFFECT BELOW*/")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/Student.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.staffFrame_6.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Staff_Btn.sizePolicy().hasHeightForWidth())
        ...
        self.Staff_Btn.setStyleSheet("/* STYLESHEET FOR PUSH BUTTON: START, SAVE, CLOSE, RESTORE, CONNECT, EDIT */\n"
                                     ...
                                     " /* SEE THE EFFECT BELOW*/")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/staff.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Class_Btn.setStyleSheet("/* STYLESHEET FOR PUSH BUTTON: START, SAVE, CLOSE, RESTORE, CONNECT, EDIT */\n"
                                     ...
                                     " /* SEE THE EFFECT BELOW*/")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/Class.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate(
            "MainWindow", "welcome to your edu-center dashboard"))
        ...
        self.Prof_Tab.setTabText(self.Prof_Tab.indexOf(
            self.Add_Prof_Tab), _translate("MainWindow", "Add Professor"))
        ...
        self.Prof_Tab.setTabText(self.Prof_Tab.indexOf(
            self.Search_Prof_Tab), _translate("MainWindow", "search"))
        self.Prof_Search_Bar2.setPlaceholderText(
            _translate("MainWindow", "search for a Professor"))
        self.Class_Search_Bar2.setPlaceholderText(
            _translate("MainWindow", "search for a class"))
        self.Add_Prof_Class_Btn.setText(_translate(
            "MainWindow", "add professor to class"))
        self.Class_Search_Bar3_Btn.setTabText(self.Class_Search_Bar3_Btn.indexOf(
            self.Add_Prof_Class_Tab), _translate("MainWindow", "Add Professor to Class"))
        self.Student_Search_Bar2.setPlaceholderText(
            _translate("MainWindow", "search fo a student"))
        self.Class_Search_Bar3.setPlaceholderText(
            _translate("MainWindow", "search for a Class"))
        self.Add_Student_Class_Btn.setText(
            _translate("MainWindow", "Add Student to Class"))
        self.Class_Search_Bar3_Btn.setTabText(self.Class_Search_Bar3_Btn.indexOf(
            self.Add_Student_Class_Tab), _translate("MainWindow", "Add Student to Class"))
        self.Class_Search_Bar3_Btn.setTabText(self.Class_Search_Bar3_Btn.indexOf(
            self.Sarch_Class_Tab), _translate("MainWindow", "search"))
        ...
        self.Student_Tab.setTabText(self.Student_Tab.indexOf(
            self.Search_Student_Tab), _translate("MainWindow", "search"))
        ...
        self.Student_Tab.setTabText(self.Student_Tab.indexOf(
            self.Add_Student_Tab), _translate("MainWindow", "Add Student"))
