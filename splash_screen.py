...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        self.circularProgress.setStyleSheet(u"QFrame{\n"
                                            "	border-radius: 150px;\n"
                                            "	background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:0.749 rgba(30, 30, 30, 0), stop:0.750 rgba(30, 30, 30, 255));\n"
                                            "}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen",
                                                           u"<html><head/><body><p><span style=\" font-weight:600; color:rgb(0,143,255);\">EDU</span>Bridge</p></body></html>",
                                                           None))
        self.labelPercentage.setText(QCoreApplication.translate("SplashScreen",
                                                                ...
                                                                None))
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by:A&M", None))
    # retranslateUi
