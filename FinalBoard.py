...
# Form implementation generated from reading ui file 'FinalBoard.ui'
#
...
"selection-color: rgb(0, 0, 0);")
        ...
        self.frame_9.setStyleSheet("border: 2px solid transparent")
...
"font: 81 italic 26pt \"Lato Heavy\";")
        ...
        self.frame_10.setStyleSheet("border: 2px solid transparent")
        self.frame_10.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_10.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_10.setObjectName("frame_10")
        self.horizontalLayout_38 = QtWidgets.QHBoxLayout(self.frame_10)
        self.horizontalLayout_38.setObjectName("horizontalLayout_38")
        self.frame_4 = QtWidgets.QFrame(self.frame_10)
        self.frame_4.setStyleSheet("border: 2px solid transparent")
        ...
        self.label_10.setStyleSheet("background-color :rgb(85,59,148);border-radius: 10px;\n"
"font: 63 italic 12pt \"Lato Semibold\";")
        self.label_10.setObjectName("label_10")
        self.gridLayout_3.addWidget(self.label_10, 0, 0, 1, 1)
        self.label_47 = QtWidgets.QLabel(self.frame_4)
        self.label_47.setMaximumSize(QtCore.QSize(16777215, 200))
        self.label_47.setStyleSheet("background-color: rgb(221, 221, 221);\n"
"border-radius: 10px;font: 63 italic 12pt \"Lato Semibold\";")
        self.label_47.setObjectName("label_47")
        self.gridLayout_3.addWidget(self.label_47, 1, 1, 1, 1)
        self.label_46 = QtWidgets.QLabel(self.frame_4)
        self.label_46.setMaximumSize(QtCore.QSize(16777215, 200))
        self.label_46.setStyleSheet("background-color: rgb(255, 213, 79);border-radius: 10px;font: 63 italic 12pt \"Lato Semibold\";")
        ...
        self.label_48.setStyleSheet("background-color: rgb(255, 37, 51);border-radius: 10px;font: 63 italic 12pt \"Lato Semibold\";")
        self.label_48.setObjectName("label_48")
        self.gridLayout_3.addWidget(self.label_48, 1, 0, 1, 1)
        self.horizontalLayout_38.addWidget(self.frame_4)
        self.frame_5 = QtWidgets.QFrame(self.frame_10)
        self.frame_5.setStyleSheet("border: 2px solid transparent")
        ...
        self.label_3.setPixmap(QtGui.QPixmap(":/icons/float.png"))
...
"}")
        ...
        self.label_9 = QtWidgets.QLabel(self.Add_Prof_Tab)
...
"}")
        ...
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.Add_Prof_Class_Tab)
...
"}")
        ...
        self.verticalLayout_12.addWidget(self.Prof_Search_Bar2)
...
"}")
        ...
        self.verticalLayout_12.addWidget(self.Class_Search_Bar2)
...
"}")
        ...
        self.verticalLayout_12.addWidget(self.Add_Prof_Class_Btn)
        self.label_49 = QtWidgets.QLabel(self.Add_Prof_Class_Tab)
        ...
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.Add_Student_Class_Tab)
...
"}")
        ...
        self.verticalLayout_14.addWidget(self.Student_Search_Bar2)
...
"}")
        ...
        self.verticalLayout_14.addWidget(self.Class_Search_Bar3)
...
"}")
        ...
        self.verticalLayout_14.addWidget(self.Add_Student_Class_Btn)
        self.label_50 = QtWidgets.QLabel(self.Add_Student_Class_Tab)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/Class.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_7.setIcon(icon5)
        self.pushButton_7.setIconSize(QtCore.QSize(50, 50))
        self.pushButton_7.setObjectName("pushButton_7")
        self.verticalLayout_9.addWidget(self.pushButton_7)
        self.import_prof_4 = QtWidgets.QPushButton(self.tab_4)
        self.import_prof_4.setMinimumSize(QtCore.QSize(0, 40))
        self.import_prof_4.setStyleSheet("QPushButton {\n"
"    border: 2px solid rgb(51,51,51);\n"
"    border-radius: 5px;    \n"
"    color:rgb(255,255,255);\n"
"    background-color: rgb(51,51,51);\n"
...
"    background-color: rgb(112,112,112);\n"
"}")
        self.import_prof_4.setObjectName("import_prof_4")
        self.verticalLayout_9.addWidget(self.import_prof_4)
        self.label_7 = QtWidgets.QLabel(self.tab_4)
        self.label_7.setMaximumSize(QtCore.QSize(16777215, 40))
        self.label_7.setText("")
        self.label_7.setObjectName("label_7")
        self.verticalLayout_9.addWidget(self.label_7)
        self.Student_Add_Btn_6 = QtWidgets.QPushButton(self.tab_4)
        self.Student_Add_Btn_6.setMinimumSize(QtCore.QSize(0, 40))
        self.Student_Add_Btn_6.setStyleSheet("QPushButton {\n"
"    border: 2px solid rgb(51,51,51);\n"
"    border-radius: 5px;    \n"
"    color:rgb(255,255,255);\n"
"    background-color: rgb(51,51,51);\n"
...
"    background-color: rgb(112,112,112);\n"
"}")
        self.Student_Add_Btn_6.setObjectName("Student_Add_Btn_6")
        self.verticalLayout_9.addWidget(self.Student_Add_Btn_6)
        self.label_8 = QtWidgets.QLabel(self.tab_4)
        self.label_8.setMaximumSize(QtCore.QSize(16777215, 40))
        self.label_8.setText("")
        self.label_8.setObjectName("label_8")
        self.verticalLayout_9.addWidget(self.label_8)
        self.Class_Search_Bar3_Btn.addTab(self.tab_4, "")
...
"  border: none;")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/edubridge-high-resolution-logo-white-transparent.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
" /* SEE THE EFFECT BELOW*/")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1256, 20))
        ...
        self.label_10.setText("Total Students: " + str(self.count('students.csv')))
        print(self.count('students.csv'))
        ...
        self.Class_Search_Bar3_Btn.setCurrentIndex(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Welcome to EduBridge"))
        ...
        self.import_prof_4.setText(_translate("MainWindow", "Import Class"))
        self.Student_Add_Btn_6.setText(_translate("MainWindow", "Export Class"))
        self.Class_Search_Bar3_Btn.setTabText(self.Class_Search_Bar3_Btn.indexOf(self.tab_4), _translate("MainWindow", "I/O"))
        ...
        self.Student_Add_Btn_5.setText(_translate("MainWindow", "Export Students"))
